        ...
        for (const engine of data) {
          ...
          if (!engineActiveModel) {
            ...
            if (firstDownloaded) {
              ...
              showToast(`模型「${firstDownloaded.name}」已在 ${engine.name} 中激活`, "success");
            }
          }
        }
      });
              ...
              return (
                <ModelRow
                  ...
                  onSetActive={() => {
                    ...
                    showToast(`已为 ${engine.name} 激活「${model.name}」`, "success");
                  }}
                />
              );
            })}
        ...
        <div className="min-w-0 flex-1">
          ...
          {!compact && (
            <div className="flex items-center gap-2 mt-0.5">
              ...
              <RatingBadge label="精度" value={model.accuracy_rating} max={5} />
              <RatingBadge label="速度" value={model.speed_rating} max={5} />
            </div>
          )}
        </div>
