...
export const NOISE_PRESETS = [
  { id: "quiet_office", name: "安静办公室", vad_sensitivity: 0.8, noise_gate_db: -40, description: "低噪声、高灵敏度 — 可捕捉轻声说话" },
  { id: "classroom", name: "教室", vad_sensitivity: 0.5, noise_gate_db: -30, description: "中等噪声、容忍回声 — 适应翻书声与低语" },
  { id: "conference_hall", name: "大会堂", vad_sensitivity: 0.3, noise_gate_db: -25, description: "高噪声、强过滤 — 大房间、混响环境" },
  { id: "cafe", name: "咖啡厅 / 开放空间", vad_sensitivity: 0.4, noise_gate_db: -28, description: "噪声多变、灵敏度均衡 — 音乐与 nearby 谈话" },
] as const;
