...
export function QuestionDetector() {
  ...
  return (
    <div className="flex flex-col gap-2.5" role="region" aria-label="检测到的问题">
      ...
      <div
        ...
        aria-label={latest ? `问题：${latest.text}。${latest.assisted ? "已回答" : "点击获取 AI 解答"}` : undefined}
      >
        ...
        {latest && (
          <div className="flex shrink-0 items-center gap-1">
            <button
              ...
              aria-label={latest.assisted ? "已回答" : "让 AI 解答该问题"}
            ...
            >
              {latest.assisted ? (
                ...
                <><Sparkles className="h-3.5 w-3.5" aria-hidden="true" />AI 解答</>
              )}
            </button>
            <button
