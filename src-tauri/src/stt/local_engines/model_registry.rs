...
static SHERPA_ONNX_MODELS: &[ModelDefinition] = &[
    ModelDefinition {
        ...
        display_name: "中文流式 Zipformer（普通话 / 简体中文，296 MB）★ 推荐",
    ...
    ModelDefinition {
        ...
        display_name: "SenseVoice 小模型（中英日韩粤多语，约 200 MB，速度极快）",
    ...
    ModelDefinition {
        ...
        display_name: "英文流式 Zipformer（小型，速度最快）",
    ...
    ModelDefinition {
        ...
        display_name: "英文流式 Zipformer（紧凑版，均衡）",
