...
use crate::group_copilot::GroupCopilotEngine;
...
pub struct AppState {
    ...
    /// 群面战术引擎（Group Copilot）— 单写入者状态机。
    pub group_copilot: Option<Arc<Mutex<GroupCopilotEngine>>>,
}
...
impl AppState {
    pub fn new() -> Self {
        Self {
            ...
            group_copilot: Some(Arc::new(Mutex::new(GroupCopilotEngine::new()))),
        }
    }
}
