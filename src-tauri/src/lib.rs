...
// == MODULE COMMANDS: group copilot ==
use commands::group_copilot_commands;
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // == COMMANDS: group copilot ==
            group_copilot_commands::group_copilot_start,
            group_copilot_commands::group_copilot_stop,
